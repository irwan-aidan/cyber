...
# Script name
MyScriptName='GuGUN21-Premium Script'
...
# Your SSH Banner
SSH_Banner='https://raw.githubusercontent.com/gugun09/AutoScriptDB/master/Files/Plugins/banner'
...
function InstWebmin(){
 ...
 WebminFile='https://github.com/gugun09/AutoScriptDB/raw/master/Files/Plugins/webmin_1.920_all.deb'
...
key-direction 0
plugin /etc/openvpn/plugins/openvpn-plugin-auth-pam.so login
server 192.168.11.0 255.255.0.0
ifconfig-pool-persist ipp.txt
push "route-method exe"
push "route-delay 2"
keepalive 10 120
...
Certificate:
    ...
    Signature Algorithm: sha256WithRSAEncryption
        Issuer: C=PH, ST=Tarlac, L=Concepcion, O=GuGUN21, OU=GuGUN21, CN=DebianVPN/name=John Ford Mangiliman/emailAddress=admin@johnfordtv.me
        Validity
            Not Before: Nov 25 08:06:59 2019 GMT
            Not After : Nov 22 08:06:59 2029 GMT
        Subject: C=PH, ST=Tarlac, L=Concepcion, O=GuGUN21, OU=GuGUN21, CN=DebianVPN/name=John Ford Mangiliman/emailAddress=admin@johnfordtv.me
        ...
        X509v3 extensions:
            ...
            X509v3 Authority Key Identifier:
                ...
                DirName:/C=PH/ST=Tarlac/L=Concepcion/O=GuGUN21/OU=GuGUN21/CN=DebianVPN/name=John Ford Mangiliman/emailAddress=admin@johnfordtv.me
...
NUovpn
 ...
 cd
 wget https://github.com/gugun09/AutoScriptDB/raw/master/Files/Plugins/plugin.tgz
...
IPCIDR='192.168.10.0/16'
IPCIDR2='192.168.11.0/16'
...
# GuGUN21's VPN Premium Script
# © Github.com/gugun09
# Official Repository: https://github.com/gugun09/AutoScriptDB
...
wget -q 'https://github.com/gugun09/AutoScriptDB/raw/master/Files/Menu/bashmenu.zip'
...
function ScriptMessage(){
 ...
 echo -e ""
 echo -e " https://fb.com/gugun09"
 echo -e "[PAYPAL] nandakanaksasak@gmail.com"
 echo -e ""
}
...
if [ "$(getconf LONG_BIT)" == "64" ]; then
 wget -O /usr/bin/badvpn-udpgw "https://github.com/gugun09/AutoScriptDB/raw/master/Files/Plugins/badvpn-udpgw64"
else
 wget -O /usr/bin/badvpn-udpgw "https://github.com/gugun09/AutoScriptDB/raw/master/Files/Plugins/badvpn-udpgw"
fi
...
if [[ "$ID" != 'debian' ]]; then
 ...
 cd ~
  ...
  # Running screenfetch
 wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/gugun09/AutoScriptDB/master/Files/Plugins/screenfetch"
...
echo " ©GuGUN21"  | tee -a log-install.txt
echo " Facebook: https://fb.me/gugun09"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo " This script is under project of https://github.com/gugun09/AutoScriptDB"  | tee -a log-install.txt
